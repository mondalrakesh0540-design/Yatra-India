...
import { 
  ...
  Star, Clock, ExternalLink, ChevronRight, Eye, Navigation, 
    ...
    <section id="map" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="text-center max-w-3xl mx-auto mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-8 pt-4 border-t border-white/10">
          ...
          {/* View Mode Switcher */}
          <div className="flex items-center gap-2 bg-navy-900/80 p-1 rounded-xl border border-white/10 shrink-0">
            <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Left 7 Columns: Full Interactive Vector SVG Map or State Grid */}
                    ...
                    >
                      ...
                      <div className="relative h-48 w-full overflow-hidden">
                        <img
                          ...
                          alt={activeSpot.name}
                          onError={(e) => { e.currentTarget.src = selectedState.heroImage; }}
                          ...
                          <div className="flex items-center gap-3 text-xs text-slate-200 mt-0.5">
                            ...
                            {activeSpot.bestTimeToVisit && (
                              <span className="flex items-center gap-1">
                                ...
                                <span>{activeSpot.bestTimeToVisit}</span>
                              </span>
                            )}
                          </div>
                        </div>
                      ...
                      <div className="p-5 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3 pt-2">
                          <Link
                            ...
                            className="py-2.5 px-4 rounded-xl bg-gradient-to-r from-saffron-500 to-amber-600 hover:from-saffron-600 hover:to-amber-700 text-white text-xs font-bold flex items-center justify-center gap-1.5 shadow-glow-saffron transition-all"
                          >
                          ...
                          <button
                            ...
                            className="py-2.5 px-4 rounded-xl bg-white/10 hover:bg-white/15 text-white text-xs font-bold flex items-center justify-center gap-1.5 border border-white/10 transition-all"
                          >
